...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        return function (e) {
            ...
            var v = this, y = {}, b = {}, x = [], C, w, _, E, N, k, S, T, R, A, B, D, M, L = {}, H = {};
        ...
        function i(i, a) {
            ...
            i = i || {}, l.schema = a = a || new e, i.fix_self_closing !== !1 && (i.fix_self_closing = !0), o("comment cdata text start end pi doctype".split(" "), function (e) {
                ...
                var l = this, c, u = 0, d, f, h = [], p, m, g, v, y, b, x, C, w, _, E, N, k, S, T, R, A, B, D, M, L, H, P, O, I, F = 0, z = t.decode, W, V = n.makeMap("src,href,data,background,formaction,poster"), U = /((java|vb)script|mhtml):/i, $ = /^data:/i;
        ...
        return function (r, l) {
            ...
            r = r || {}, r.validate = "validate"in r ? r.validate : !0, r.root_name = r.root_name || "body", u.schema = l = l || new t, u.filterNode = function (e) {
                ...
                var v, y, b, x, C, w, _, E, N, k, S, T, R, A = [], B, D, M, L, H, P, O, I;
                if (o = o || {}, h = {}, p = {}, T = s(i("script,style,head,html,body,title,meta,param"), l.getBlockElements()), O = l.getNonEmptyElements(), P = l.children, S = r.validate, I = "forced_root_block"in o ? o.forced_root_block : r.forced_root_block, H = l.getWhiteSpaceElements(), R = /^[ \t\r\n]+/, D = /[ \t\r\n]+$/, M = /[ \t\r\n]+/g, L = /^[ \t\r\n]+$/, v = new n({
                        validate: S,
        ...
        return function (r, i) {
            ...
            function a(t) {
                var n, r, o, a, s;
                n = t.screenX - T, r = t.screenY - R, P = n * k[2] + D, O = r * k[3] + M, P = 5 > P ? 5 : P, O = 5 > O ? 5 : O, o = "IMG" == w.nodeName && i.settings.resize_img_proportional !== !1 ? !e.modifierPressed(t) : e.modifierPressed(t) || "IMG" == w.nodeName && k[2] * k[3] !== 0, o && (W(n) > W(r) ? (O = V(P * L), P = V(O / L)) : (P = V(O / L), O = V(P * L))), x.setStyles(_, {
                    width: P,
                    height: O
            ...
            function l(e, t, r) {
                ...
                g(), l = x.getPos(e, U), A = l.x, B = l.y, h = e.getBoundingClientRect(), u = h.width || h.right - h.left, d = h.height || h.bottom - h.top, w != e && (m(), w = e, P = O = 0), f = i.fire("ObjectSelected", {target: e}), o(e) && !f.isDefaultPrevented() ? C(N, function (e, i) {
                    function o(t) {
                        T = t.screenX, R = t.screenY, D = w.clientWidth, M = w.clientHeight, L = M / D, k = e, e.startPos = {
                            x: u * e[0] + A,
                            y: d * e[1] + B
            ...
            function h(e) {
                ...
                n = t.getBoundingClientRect(),
                    c = S.clientX - n.left, u = S.clientY - n.top;
            ...
            var x = i.dom, C = t.each, w, _, E, N, k, S, T, R, A, B, D, M, L, H, P, O, I = i.getDoc(), F = document, z = n.ie && n.ie < 11, W = Math.abs, V = Math.round, U = i.getBody(), $, q;
            ...
            function O(e, t, n, r) {
                ...
                if ("all" != e.remove)for (le(e.styles, function (i, o) {
                    ...
                    if (e = D(e, t), "number" == typeof i && (i = e, r = 0), !r || R(q.getAttrib(r, i), e)) {
                        if ("class" == i && (e = q.getAttrib(n, i),
                            e && (o = "", le(e.split(/\s+/), function (e) {
                                /mce\-\w+/.test(e) && (o += (o ? " " : "") + e)
            ...
            function o(o) {
                ...
                function x(e, t) {
                    ...
                    if (r = a.getParent(e, a.isBlock), c = i.getBody().nodeName.toLowerCase(), !r || !h(r)) {
                        if (r = r || R, !r.hasChildNodes())return n = a.create(d), v(n), r.appendChild(n), S.setStart(n, 0), S.setEnd(n, 0), n;
                ...
                function C() {
                    ...
                    /^(OL|UL|LI)$/.test(n) && (z = "LI"), H = z ? y(z) : a.create("BR"), e(!0) && e() ? "LI" == n ? a.insertAfter(H, t()) : a.replace(H, O) : e(!0) ? "LI" == n ? (a.insertAfter(H, t()), H.appendChild(a.doc.createTextNode(" ")), H.appendChild(O)) : O.parentNode.insertBefore(H, O) : e() ? (a.insertAfter(H, t()), p(H)) : (O = t(), T = S.cloneRange(), T.setStartAfter(D), T.setEndAfter(O), P = T.extractContents(), "LI" == z && "LI" == P.firstChild.nodeName ? (H = P.firstChild, a.insertAfter(P, O)) : (a.insertAfter(P, O), a.insertAfter(H, O))), a.remove(D), g(H), c.add()
                }
                ...
                var S, T, R, A, B, D, M, L, H, P, O, I, F, z, W;
                if (S = s.getRng(!0), !o.isDefaultPrevented()) {
                    if (!S.collapsed)return void i.execCommand("Delete");
                    if (new t(a).normalize(S), A = S.startContainer, B = S.startOffset, z = (l.force_p_newlines ? "p" : "") || l.forced_root_block, z = z ? z.toUpperCase() : "", M = a.doc.documentMode, L = o.shiftKey, 1 == A.nodeType && A.hasChildNodes() && (W = B > A.childNodes.length - 1, A = A.childNodes[Math.min(B, A.childNodes.length - 1)] || A, B = W && 3 == A.nodeType ? A.nodeValue.length : 0), R = E(A)) {
                        ...
                        z && D === i.getBody() || (z = z || "P", b() ? k() : b(!0) ? (H = D.parentNode.insertBefore(y(), D), p(H), g(D)) : (T = S.cloneRange(), T.setEndAfter(D), P = T.extractContents(), _(P), H = P.firstChild, a.insertAfter(P, D), m(H), N(D), a.isEmpty(H) ? (a.remove(H), k()) : g(H)), a.setAttrib(H, "id", ""), i.fire("NewBlock", {newBlock: H}), c.add())
                    }
                }
            }
        ...
        return function (r) {
            ...
            r.on("PreInit", function () {
                ...
                "mceResetDesignMode,mceBeginUndoLevel": function () {
                    ...
                    var t, n, i;
                    t = H.indentation, n = /[a-z%]+$/i.exec(t), t = parseInt(t, 10), y("InsertUnorderedList") || y("InsertOrderedList") ? k(e) : (H.forced_root_block || B.getParent(D.getNode(), B.isBlock) || M.apply("div"), s(D.getSelectedBlocks(), function (o) {
                        if ("LI" != o.nodeName) {
        ...
        return function (s) {
            ...
            k(), m(), H(), re && (p(), v(), x(), R(), U(), _(), $(), o.iOS ? (O(), I(), V()) : g()), ne && o.ie < 11 && (y(), w(), E(), N(), B(), D(), M(), L()), o.ie >= 11 && (I(), W(), _()), o.ie && (g(), z(), q()), te && (y(), b(), C(), S(), T(), A(), P(), F(), _())
        }
    ...
    }), r(Ee, [b, h, C, _, E, A, R, H, I, F, z, W, V, U, x, l, he, N, S, pe, u, f, me, ge, _e], function (e, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v, y, b, x, C, w, _, E, N) {
        function k(e, t, i) {
            var o = this, a, s;
        ...
        var S = e.DOM, T = r.ThemeManager, R = r.PluginManager, A = w.extend, B = w.each, D = w.explode, M = w.inArray, L = w.trim, H = w.resolve, P = g.Event, O = C.gecko, I = C.ie;
        return k.prototype = {
            render: function () {
                function e() {
        ...
        return e.extend({
            recalc: function (e) {
                ...
                if (w += g.left + g.right, _ += g.top + g.bottom, l = {}, l.minW = w + (o.w - o.innerW),
                        l.minH = _ + (o.h - o.innerH), l.contentW = l.minW - o.deltaW, l.contentH = l.minH - o.deltaH, l.minW = Math.min(l.minW, o.maxW), l.minH = Math.min(l.minH, o.maxH), l.minW = Math.max(l.minW, o.startMinWidth), l.minH = Math.max(l.minH, o.startMinHeight), !o.autoResize || l.minW == o.minW && l.minH == o.minH) {
    ...
    }),a([l, c, u, f, h, p, m, v, b, x, C, w, E, N, k, S, T, R, A, D, M, L, H, I, F, V, U, $, q, K, G, X, ee, te, ne, re, ie, oe, ae, se, le, ce, ue, de, fe, he, me, ge, ve, Ee, Ne, ke, Se, Re, Ae, Be, De, Me, Le, He, Pe, Oe, Ie, Fe, ze, We, Ve, Ue, $e, qe, je, Ke, Ye, Ge, Xe, Je, Qe, Ze, et, tt, nt, rt, it, ot, at, st, lt, ct, ut, dt, ft, ht, pt, mt, gt, vt, yt, bt, xt, Ct, wt])
}(this);