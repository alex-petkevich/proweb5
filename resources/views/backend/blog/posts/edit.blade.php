...
@section('main')
    ...
    <div class="col-xs-10">
        ...
        @if ($post->id)
            <h1 class="post-header">{!! trans('posts.edit_post') !!}</h1>
        ...
        <div class="hidden" id="additional_options">
            ...
            <div class="form-group @if ($errors->has('file')) has-error has-feedback @endif">
                ...
                <img src="{!! Croppa::url($post->avatar, 100, null) !!}" id="thumb"
                     style="max-width:300px; max-height: 200px;@if ($post->avatar == '') display: none;@endif"
                     class="img-thumbnail">
                {!! Form::hidden('image', $post->avatar) !!}
