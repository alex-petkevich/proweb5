...
<div class="well">
   ...
   <div class="form-group">
      {!! Form::label('search-active', trans('promos.active'), array('class' => 'control-label')) !!}
...
<table class="table table-striped table-hover table-condensed">
   <thead>
      <tr>
         ...
         <th>{!! trans('promos.clicks') !!} / {!! trans('promos.shows') !!}</th>
   ...
   <tbody>
      ...
      <tr @if (!$promo->active) class="tr-disabled" @endif id="tr-{!! $promo->id !!}">
           <td><img src="{!! Imagecache::get($promo->img, '150x150')->src !!}" id="thumb"
         ...
         <td>{{{ $promo->clicks }}} / {{{ $promo->shows }}}</td>
